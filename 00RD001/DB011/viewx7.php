<html>	<meta http-equiv="content-type" content="text/html; charset=utf-8">
	<head><title>*** View07 ***</title></head><body>
		<table border="1">
<?php
...
print("Drop view01-04 completed ");

/*	
$sql = "CREATE OR REPLACE VIEW View04 AS SELECT C_Name,C_Yoshin FROM customer2 WHERE C_Yoshin>=200000 WITH CHECK OPTION";
$sql = "ALTER VIEW View04 AS SELECT C_Name,C_Yoshin FROM customer2 WHERE C_Yoshin>=200000 WITH CHECK OPTION";
$res = mysqli_query($conn, $sql);
